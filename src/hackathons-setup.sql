...
CREATE TABLE Organizer(email CHAR(40) PRIMARY KEY, oname CHAR(30), phoneNum CHAR(20))
GRANT SELECT ON Organizer TO public
CREATE TABLE Caterer( cname CHAR(30) PRIMARY KEY, budget INTEGER)
GRANT SELECT ON Caterer TO public
CREATE TABLE ParticipantSchool( psname CHAR(40) PRIMARY KEY, pslocation CHAR(30))
GRANT SELECT ON ParticipantSchool TO public
CREATE TABLE Guest(gID INTEGER PRIMARY KEY, gname CHAR(30))
GRANT SELECT ON Guest TO public
CREATE TABLE Participant(ID INTEGER PRIMARY KEY, pname CHAR(30), email CHAR(40), school CHAR(40), FOREIGN KEY (school) REFERENCES ParticipantSchool(psname) ON DELETE CASCADE)
GRANT SELECT ON Participant TO public
CREATE TABLE Hackathon(hname CHAR(30) PRIMARY KEY, Oemail CHAR(40) NOT NULL, hdate DATE, hlocation CHAR(40), FOREIGN KEY (Oemail) REFERENCES Organizer(email) ON DELETE CASCADE)
GRANT SELECT ON Hackathon TO public
CREATE TABLE SponsorshipOutreach(email CHAR(40) PRIMARY KEY, industry CHAR(30), FOREIGN KEY (email) REFERENCES Organizer(email) ON DELETE CASCADE)
GRANT SELECT ON SponsorshipOutreach TO public
CREATE TABLE MarketingRecruitment(email CHAR(40) PRIMARY KEY, socialMediaPlatform CHAR(30), FOREIGN KEY (email) REFERENCES Organizer(email) ON DELETE CASCADE)
GRANT SELECT ON MarketingRecruitment TO public
CREATE TABLE Hospitality(email CHAR(40) PRIMARY KEY, caterer CHAR(30) UNIQUE, FOREIGN KEY (caterer) REFERENCES Caterer, FOREIGN KEY (email) REFERENCES Organizer(email) ON DELETE CASCADE)
GRANT SELECT ON Hospitality TO public
CREATE TABLE Mentor(ID INTEGER PRIMARY KEY,	bestLanguage CHAR(20), areaOfExpertise CHAR(30), FOREIGN KEY (ID) REFERENCES Guest(gID) ON DELETE CASCADE)
GRANT SELECT ON Mentor TO public
CREATE TABLE GuestSpeaker(ID INTEGER PRIMARY KEY, topic CHAR(50), FOREIGN KEY (ID) REFERENCES Guest(gID) ON DELETE CASCADE)
GRANT SELECT ON GuestSpeaker TO public
CREATE TABLE Volunteer(ID INTEGER PRIMARY KEY, MRemail CHAR(40) NOT NULL, vname CHAR(40), vrole CHAR(20), email CHAR(40), phoneNum CHAR(20), FOREIGN KEY (MRemail) REFERENCES MarketingRecruitment(email) ON DELETE CASCADE)
GRANT SELECT ON Volunteer TO public
CREATE TABLE Company(cname CHAR(30) PRIMARY KEY, SOemail  CHAR(40),	phoneNum CHAR(20), email CHAR(40),FOREIGN KEY (SOemail) REFERENCES SponsorshipOutreach(email) ON DELETE CASCADE)
GRANT SELECT ON Company TO public
CREATE TABLE CompanyRepresentative(ID INTEGER PRIMARY KEY, Cname CHAR(30) NOT NULL, FOREIGN KEY(ID) REFERENCES Guest ON DELETE CASCADE, FOREIGN KEY(Cname) REFERENCES Company(cname) ON DELETE CASCADE)
GRANT SELECT ON CompanyRepresentative TO public
CREATE TABLE Workshop(title CHAR(80) PRIMARY KEY, wtime CHAR(30), roomNum CHAR(20))
GRANT SELECT ON Workshop TO public
CREATE TABLE HelpsRun (vID INTEGER, hName CHAR(30), FOREIGN KEY(vID) REFERENCES Volunteer ON DELETE CASCADE, FOREIGN KEY(hName) REFERENCES Hackathon ON DELETE CASCADE, PRIMARY KEY(vID, hName))
GRANT SELECT ON HelpsRun TO public
CREATE TABLE Contains(hName CHAR(30), wTitle CHAR(80), FOREIGN KEY(hName) REFERENCES Hackathon(hname) ON DELETE CASCADE, FOREIGN KEY(wTitle) REFERENCES Workshop(title) ON DELETE CASCADE, PRIMARY KEY(hName, wTitle))
GRANT SELECT ON Contains TO public
CREATE TABLE RegistersFor(pID INTEGER, wTitle CHAR(80), FOREIGN KEY(pID) REFERENCES Participant(ID) ON DELETE CASCADE, FOREIGN KEY(wTitle) REFERENCES Workshop(title) ON DELETE CASCADE, PRIMARY KEY(pID, wTitle))
GRANT SELECT ON RegistersFor TO public
CREATE TABLE ParticipatesIn(pID INTEGER, hName CHAR(30), FOREIGN KEY(pID) REFERENCES Participant(ID) ON DELETE CASCADE, FOREIGN KEY(hName) REFERENCES Hackathon(hname) ON DELETE CASCADE, PRIMARY KEY(pID, hName))
GRANT SELECT ON ParticipatesIn TO public
CREATE TABLE Sponsors(hName CHAR(30), cName CHAR(30), FOREIGN KEY(hName) REFERENCES Hackathon(hname) ON DELETE CASCADE, FOREIGN KEY(cName) REFERENCES Company(cname) ON DELETE CASCADE, PRIMARY KEY(hName, cName))
GRANT SELECT ON Sponsors TO public
CREATE TABLE Attends(gID INTEGER, hName CHAR(30), FOREIGN KEY(gID) REFERENCES Guest(gID) ON DELETE CASCADE, FOREIGN KEY(hName) REFERENCES Hackathon(hname) ON DELETE CASCADE, PRIMARY KEY(gID, hName))
GRANT SELECT ON Attends TO public
CREATE TABLE Mentors(mID INTEGER, pID INTEGER, FOREIGN KEY(mID) REFERENCES Mentor(ID) ON DELETE CASCADE, FOREIGN KEY(pID) REFERENCES Participant(ID) ON DELETE CASCADE, PRIMARY KEY(mID, pID))
